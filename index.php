...
$option = array( 
    ...
    array($telegram->buildInlineKeyBoardButton("📊 לערוץ הביקורת 📋", sendMessage?chat_id=$chat_id&text="Hi"), $telegram->buildInlineKeyBoardButton("📊 לערוץ הביקורת 📋", sendmessage?chat_id=".$chat_id."&text=test")) );
